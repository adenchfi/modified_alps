...
IF(Hdf5_INCLUDE_DIRS)
  ...
  FIND_PATH(HDF5_INCLUDE_DIR NAMES hdf5.h PATHS ${Hdf5_INCLUDE_DIRS} NO_DEFAULT_PATH)
  FIND_LIBRARY(HDF5_LIBRARIES hdf5 ${Hdf5_LIBRARY_DIRS} NO_DEFAULT_PATH)
...
#  SET(HDF5_LIBRARIES "" CACHE STRING "HDF5 libraries" FORCE)
  ...
  IF (WIN32 AND NOT UNIX)
    ...
    FIND_FILE(HDF5_DLLS hdf5dll.dll ${VISTRAILS_APP_DIR}/${VISTRAILS_APP_NAME}/libsrc/hdf5-1.8.4-64bit-VS2008-IVF101/dll ${VISTRAILS_APP_DIR}/${VISTRAILS_APP_NAME}/libsrc/hdf5-1.8.4-32bit-VS2008-IVF101/dll NO_DEFAULT_PATH) 
    SET(HDF5_FOUND TRUE)  
  ENDIF (WIN32 AND NOT UNIX)
  IF (APPLE)
...
if (HDF5_INCLUDE_DIR)
    if( EXISTS "${HDF5_INCLUDE_DIR}/H5pubconf.h" )
       ...
       if(threadsafe_define_)
         ...
         message(STATUS "HDF5 without THREADSAFE mode. ALPS will ensure thread safety by HDF5 running sequentially.")
